package net.interalia{
	...
	import net.interalia.events.EtniaFacebookConnectLoadEvent;
	import net.interalia.events.EtniaFacebookConnectLoginEvent;
	...
	public class EtniaFacebookConnect extends EventDispatcher{
		...
		public function EtniaFacebookConnect($id:String, $accessToken:String = null):void{
			trace("*FacebookUser by Haunter66*");
