package net.interalia.etnia.ui.mvc.userpicture.views {
	...
	public class StandardPicturePickerGraphView extends UserPicturePickerBasicGraphView implements IView {
		...
		protected var _loaderFilePoint:Point;
		protected var _loaderFBPoint:Point;
		...
		public function set loaderFilePoint($point:Point):void{
			_loaderFilePoint = $point;
		}
		
		public function set loaderFBPoint($point:Point):void{
		...
		override protected function setWebcamPictureView():void {
			var view:StandardWebcamView = new StandardWebcamView(userPickerModel.webcamPicModel,
				userPickerModel.selectFileController, _graphics.webcamPPGraphic);
		...
		override protected function setUserPickerView():void {
			var view:IView = new _fileReferenceView(userPickerModel.userFileModel,
				userPickerModel.selectFileController, _graphics.userFilePPGraphic);
			(view as StandardFileReferenceGraphView).loaderPoint = _loaderFilePoint;
			(view as StandardFileReferenceGraphView).loaderClass = _loaderClass;
			addView(view);
		}
